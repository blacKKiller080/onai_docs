...
import 'package:onai_docs/src/features/auth/repository/auth_repository_impl.dart';
import 'package:onai_docs/src/features/client/task/repository/task_repository.dart';
import 'package:onai_docs/src/features/client/task/repository/task_repository_impl.dart';

import 'package:onai_docs/src/features/settings/database/settings_dao.dart';
import 'package:onai_docs/src/features/settings/repository/settings_repository.dart';
...
class RepositoryStorage implements IRepositoryStorage {
  ...
  @override
  ITaskRepository get taskRepository => TaskRepositoryImpl(
        authDao: AuthDao(sharedPreferences: _sharedPreferences),
