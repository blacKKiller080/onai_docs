...
mixin AppColors {
  static const Color kMainBlue = Color(0xff256ED8);
  static const Color kMainOrange = Color(0xFFFF7F3F);

  static const Color kGlobalBackground = Color(0xffF8F8F8);
  ...
  static const Color kGreyDivider = Color(0xffEFF1F3);
